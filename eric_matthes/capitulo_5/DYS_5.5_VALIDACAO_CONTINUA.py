...
while True:
    ...
    # Validação contínua: SUPER SUPER IMPORTNATE: Enquanto a idade for inválida (menor que 0 ou maior que 120),o programa continua a pedir 
    # até o utilizador escrever um valor correto. NUNCA ESQUECER: “Se algo pode estar errado, eu tenho de repetir até estar certo.”
